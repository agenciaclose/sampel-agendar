...
$router->post("/painel/patrocinios/add/save", "PatrociniosPainelController:productAddSave");
$router->post("/painel/patrocinios/edit/save", "PatrociniosPainelController:productEditSave");
