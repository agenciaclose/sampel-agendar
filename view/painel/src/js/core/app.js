...
(function (window, document, $) {
  ...
  $('.nav-link-style').on('click', function () {
    ...
    var switchToLayout = $('body').attr('data-layout');
    
    if(switchToLayout == 'light-layout'){
      setCookie('siteStyle', 'dark-layout', 365);
    }else{
      setCookie('siteStyle', 'light-layout', 365);
    }
...
$('.acAction').click(function(e){
    let item = $(this).attr('data-item');
    e.preventDefault();
    $.ajax({
        url: domain + '/painel/servicos/agendamentos/agendamento-concluido/'+item,
        type: 'GET',
        success: function(data){
            if (data === "1") {
                swal({type: 'success',title: 'CONCLUÍDO COM SUCESSO!',showConfirmButton: false,timer: 2000});
                setTimeout(function() {location.reload();}, 2000);
            }else{
                swal({type: 'error',title: 'ERRO AO CONCLUIR!',showConfirmButton: false,timer: 2000});
            }
        },
        processData: false,
        cache: false,
