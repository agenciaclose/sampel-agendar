...
class EventosPainelController extends Controller
{
    ...
    public function productAdd($params)
    {
        ...
        $this->render('painel/pages/eventos/form.twig', ['paises' => $paises]);
    }
    ...
    public function productStatus($params)
    {
        ...
        //VERIFICA SE EXISTE PEDIDOS NAQUELE EVENTO
        $model = new PedidosPainel();
        $pedidos = $model->getPedidoOrcamentoID($params['id'], 'eventos');
