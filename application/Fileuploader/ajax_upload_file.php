<?php
	...
	if (!file_exists('../../uploads/produtos/'.$usuario['slug'].'/'.$ano.'/'.$mes.'/')) {
		mkdir('../../uploads/produtos/'.$usuario['slug'].'/'.$ano.'/'.$mes.'/', 0777, true);
	}

	$caminho = '../../uploads/produtos/'.$usuario['slug'].'/'.$ano.'/'.$mes.'/';
	...
	if (isset($_POST['fileuploader']) && isset($_POST['_editingg'])) {}else{
		...
		$foto_completa	= DOMAIN.'/uploads/produtos/'.$usuario['slug'].'/'.$ano.'/'.$mes.'/'.strtolower($nome);
	...
	if($upload){
			...
			if (!file_exists('../../uploads/produtos_thumbnail/'.$usuario['slug'].'/'.$ano.'/'.$mes.'/')) {
				mkdir('../../uploads/produtos_thumbnail/'.$usuario['slug'].'/'.$ano.'/'.$mes.'/', 0777, true);
			}
			...
			$image->source_path = '../../uploads/produtos/'.$usuario['slug'].'/'.$ano.'/'.$mes.'/'.strtolower($dados_imagens['nome']);

			$image->target_path = '../../uploads/produtos_thumbnail/'.$usuario['slug'].'/'.$ano.'/'.$mes.'/'.$nome[0].'.jpg';
